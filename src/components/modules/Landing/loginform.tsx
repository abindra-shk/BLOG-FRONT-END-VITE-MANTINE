...
return(
    props.open &&(<DialogBox open={props.open} close={props.close} isSwitched={props.isSwitched}>
        ...
        <div className="border border-black w-1/2 rounded-full my-1 py-1 flex items-center justify-center cursor-pointer" onClick={()=>navigate('/signin')}><img className="w-4 h-4 inline ml-2" src={email}/><span className="flex-1 text-center">Sign in with email</span></div>
